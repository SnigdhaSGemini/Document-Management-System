...
const Dashboard = () => {
  ...
  const [documentDetails, setDocumentDetails] = useState<{ totalDocuments: number, approved: number, assignedDrafts: number, delegated: number, pendingReviews: number, recentlyAdded: number, rejected: number, reviewedDocuments: number, statusChart, documentsTimeGraph: []}>();
    ...
    <>
      <div className="h-full w-full">
        <div className="mx-5 mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="col-span-1 flex items-center gap-4 rounded-xl p-4 h-20 bg-violet-100 hover:bg-violet-200 cursor-pointer transition"
          onClick={()=> navigate("/my-drafts")}>
          ...
          <div className="col-span-1 flex items-center gap-4 rounded-xl p-4 h-20 bg-green-100 hover:bg-green-200 cursor-pointer transition"
          onClick={()=> navigate("/review-outcomes")}>
          ...
          <div className="col-span-1 flex items-center gap-4 rounded-xl p-4 h-20 bg-red-100 hover:bg-red-200 cursor-pointer transition"
          onClick={()=> navigate("/review-outcomes")}>
          ...
          <div className="col-span-1 flex items-center gap-4 rounded-xl p-4 h-20 bg-amber-100 hover:bg-amber-200 cursor-pointer transition"
          ...
          <div className="col-span-1 flex items-center gap-4 rounded-xl p-4 h-20 bg-teal-100 hover:bg-teal-200 cursor-pointer transition"
          onClick={()=> navigate("/assigned-drafts")}>
          ...
          <div className="col-span-1 flex items-center gap-4 rounded-xl p-4 h-20 bg-pink-100 hover:bg-pink-200 cursor-pointer transition"
          onClick={()=> navigate("/reviewed-documents")}>
          ...
          <div className="col-span-1 flex items-center gap-4 rounded-xl p-4 h-20 bg-cyan-100 hover:bg-cyan-200 cursor-pointer transition"
          onClick={()=> navigate("/delegated-to-admin")}>
            <div className="h-10 w-10 flex items-center justify-center rounded-xl bg-cyan-50">
              <MdOutlineArrowCircleRight className="h-6 w-6 text-cyan-800" />
            </div>
            <div>
              <h1 className="text-slate-800 font-semibold">Delegated</h1>
              <p className="text-slate-600">{documentDetails?.delegated || 0}</p>
            </div>
          </div>
